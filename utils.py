...
def save_checkpoint(save_path, dispnet_state, exp_pose_state, optimizer_state, is_best, filename='checkpoint.pth.tar'):
    file_prefixes = [dispnet_state['name'], exp_pose_state['name'], optimizer_state['name']]
    states = [dispnet_state, exp_pose_state, optimizer_state]
